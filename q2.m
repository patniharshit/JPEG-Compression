...
figure;
subplot(1,5,1); imshow(clip1); title('Image');
subplot(1,5,2); imshow(dc1); title('DCT');
subplot(1,5,3); imshow(quant1); title('Qunatized');
subplot(1,5,4); imshow(dequant1); title('Dequantized');
...
figure;
subplot(1,5,1); imshow(clip2); title('Image');
subplot(1,5,2); imshow(dc2); title('DCT');
subplot(1,5,3); imshow(quant2); title('Qunatized');
subplot(1,5,4); imshow(dequant2); title('Dequantized');
...
figure;
subplot(1,5,1); imshow(clip3); title('Image');
subplot(1,5,2); imshow(dc3); title('DCT');
subplot(1,5,3); imshow(quant3); title('Qunatized');
subplot(1,5,4); imshow(dequant3); title('Dequantized');
